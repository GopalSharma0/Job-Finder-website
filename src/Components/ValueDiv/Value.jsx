        ...
        <div className="singleGrid rounded-[10px] hover:bg-[#eeedf7] p-[1.5rem]">
          ...
          <p className="text-[13px] text-textColor opacity-[.7] py-[1rem] font-semibold">
            ...
            little bit
                      ...
                      <div className="card mt-[2rem] flex justify-between bg-blueColor p-[5rem] rounde=[10px]">
                        <div>
                          <h1 className="text-blueColor text-[30px] font-bold"> Ready to switch a carreer
                          </h1>
                          <h2 className="text-textColor text-[25px] font-bold">Lets gets started</h2>
                        </div>

                        <button className="border-[2px] rounded-[16px] py-[4px] px-[50px] text-[18px] font-semibold text-blueColor hover:bg-white border-blueColor">
                          Get Started
                        </button>
                      </div>
    </div>
