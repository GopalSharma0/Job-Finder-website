  ...
  return (
    <div className='footer p-[5rem] mb-4 bg-blueColor rounded-[10px] gap-8 grid grid-cols-5 m-auto items-center justify-center'>
      <div>
        ...
        <p className='text-white pb-[13px]opacity-70 leadig-7'>
          we always make our seekers and companies find the best jobs and and employers find the best candidates
        </p>
      </div>
      ...
      <div className='grid' >
        ...
        <div className='grid gap-3' >
          ...
          <li className='text-white opacity-[.7] hover:opacity-[1]'>Carriers</li>
      ...
      <div className='grid'>
        ...
        <div>
          <small className='text-[14px] text-white'>gopalsharma3025@gmail.com</small>
